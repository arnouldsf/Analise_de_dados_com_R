...
#vetor: possui uma dimensão e um tipo específico de dado
vetor1 <- c(1:10)
vetor1
length(vetor1)
class(vetor1)
...
#maneira mais facil de explicar data frames é matriz com diferentes tipos de dados
View(iris)
length(iris)
mode(iris)
class(iris)
...
#Funções: tambem são vistas como objetos no R
func1 <- function(x){
  var1 <- x*x
  return(var1)
}
